...
- **Gap — official practice exam not yet located, but narrowed down.** The guide's final prep recommendation (#8) references "the practice exam" (60 questions, same scenario format, post-answer explanations), link "provided separately." Checked 2026-07-28: the course page at [anthropic-partners.skilljar.com/claude-certified-architect-foundations-certification](https://anthropic-partners.skilljar.com/claude-certified-architect-foundations-certification) gates full content behind "Purchase | $125" or "Sign In" if already purchased, and links a **[Prep Courses page](https://anthropic-partners.skilljar.com/page/claude-certified-architect-foundations-prep-courses)** in its nav — most likely where the practice exam lives. Needs the user's own account to access; not fetchable by an unauthenticated tool. Update this entry once the actual practice-exam link is confirmed from inside the portal. Treat reference/scenario-drills.html as a substitute in the meantime, not equivalent to it.
- Unverified third-party mentions surfaced in search (a Medium writeup, findskill.ai, an `anthropic.skilljar.com`-subdomain "access request" URL) — none independently confirmed; do not treat as fact until checked against the actual portal.
